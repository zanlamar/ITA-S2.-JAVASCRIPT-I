...
/* NIVEL 1
    ...
    const calculadora = (num1, num2, callbackNums) => callbackNums(num1, num2);
    const callbackNums = (num1, num2) => num1 + num2;

    console.log(calculadora(8, 3, callbackNums));
 ...
 /* NIVEL 2
    ...
    const esperarISaludar = (nom, callbackHi) => {
        setTimeout(() => {
            callbackHi(nom);
        }, 2000);
    };

    const callbackHi = (nom) => console.log(`Hello ${nom}!`);
    esperarISaludar('Susan', callbackHi);
    ...
    const processarElements = (array3, callbackArr) => {
    ...
    processarElements(array3, callbackArr);
    ...
    const processarCadena = (string, callbackTransform) => {
    ...
    processarCadena('Altamira', callbackTransform);
